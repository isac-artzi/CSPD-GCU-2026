...
- 💻 **Setup guide — Mac vs Windows (installing VS Code, Python, Git, Claude Code)** → [`afternoon/00-setup-mac-vs-windows.md`](afternoon/00-setup-mac-vs-windows.md) *(or the styled `.html` in that folder — double-click to open in a browser)*
